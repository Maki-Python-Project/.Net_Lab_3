...
namespace Lab3
{
    internal class StudentCollection
    {
        ...
        public void AddDefaults()
        {
            ...
            _students.Add(new Student(new Person("Maksym", "Dobzhinetskii", new DateOnly(2002, 08, 20)), Education.Master, 301) { Exams = new List<Exam>() { new Exam(), new Exam("Programming", 2, new DateOnly(2021, 6, 3)) } });
        }
